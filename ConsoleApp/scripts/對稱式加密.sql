...
alter symmetric key my_key add encryption  by password = 'my_new_password'; -- 新增密碼
close symmetric key my_key;

open  symmetric key my_key decryption      by password = 'my_new_password';
alter symmetric key my_key drop encryption by password = 'my_new_password'; -- 移除舊密碼
close symmetric key my_key;
*/
